...
st.markdown('This app provides insights into crime trends occurring in Toronto, Canada.  Data is from [Toronto Police Service](https://data.torontopolice.on.ca/pages/major-crime-indicators) and [Toronto Open Data](https://www.toronto.ca/city-government/data-research-maps/open-data/)')
st.markdown("""
