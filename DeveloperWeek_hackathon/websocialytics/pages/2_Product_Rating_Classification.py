...
st.header("Product Ratings Prediction")

model_df = df[['ProductModelName','ProductCategory','ProductPrice',
...
#drop down
nlp_product_list = model_df['ProductModelName'].unique()
nlp_product_list  = nlp_product_list.astype('str')
nlp_product_list.sort()
