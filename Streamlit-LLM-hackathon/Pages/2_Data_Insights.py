...
Printer Score
st.subheader("Companion App Score")
...
st.subheader("Companion App review Count")
...
st.subheader("Companion App Score trend")
...
st.subheader("Companion App Thumbs Up Count")
